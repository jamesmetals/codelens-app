...
> Runtime note for Codex: when this repository is operated from Codex, apply `.agent/rules/CODEX.md` for tool mapping, plan-artifact detection, and delegation behavior. This file remains the original source workflow for the Antigravity/Claude-style runtime.
